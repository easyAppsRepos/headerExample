...
(function(){
  ...
  ionSlider.$inject = ['$ionicModal','$ionicPopup','ionGalleryHelper','$ionicPlatform','$timeout','$ionicScrollDelegate'];

  function ionSlider($ionicModal,$ionicPopup, ionGalleryHelper,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function controller($scope){
      ...
      $scope.onHold = function(key,pos){
          var confirmPopup = $ionicPopup.confirm({
     title: 'Borrar Imagen',
     template: 'Deseas borrar la imagen de la galeria?'
   });

   confirmPopup.then(function(res) {
     if(res) {
       console.log('Borrada:'+key);
              console.log('pos:'+pos);
              $scope.ionGalleryItems.splice(pos);
     } else {
